...
<nav x-data="{ open: false }" class="navbar bg-gradient-to-r from-pink-400 via-pink-500 to-pink-600 text-white shadow-lg">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-nav-link :href="route('doctores.index')" :active="request()->routeIs('doctores.index')" class="text-white hover:text-gray-200">
                        {{ __('Doctores') }}
                    </x-nav-link>
                    <x-nav-link :href="route('secretarias.index')" :active="request()->routeIs('secretarias.index')" class="text-white hover:text-gray-200">
                        {{ __('Secretarias') }}
                    </x-nav-link>
                    <x-nav-link :href="route('pacientes.index')" :active="request()->routeIs('pacientes.index')" class="text-white hover:text-gray-200">
                        {{ __('Pacientes') }}
                    </x-nav-link>
                    <x-nav-link :href="route('servicios.index')" :active="request()->routeIs('servicios.index')" class="text-white hover:text-gray-200">
                        {{ __('Servicios') }}
                    </x-nav-link>
                    <x-nav-link :href="route('productos.index')" :active="request()->routeIs('productos.index')" class="text-white hover:text-gray-200">
                        {{ __('Productos') }}
                    </x-nav-link>
                    <x-nav-link :href="route('citas.index')" :active="request()->routeIs('citas.index')" class="text-white hover:text-gray-200">
                        {{ __('Citas') }}
                    </x-nav-link>
                </div>
            </div>
            ...
            <div class="-mr-2 flex items-center sm:hidden">
                <button @click="open = ! open" class="inline-flex items-center justify-center p-2 rounded-md text-white hover:text-gray-200 hover:bg-pink-600 focus:outline-none focus:bg-pink-600 focus:text-gray-200 transition duration-150 ease-in-out">
