    ...
    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
        ...
        <tbody>
            ...
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                ...
                <td class="px-6 py-4">
                    <a href="{{ route('doctores.editar', $doctor->id) }}" class="font-medium text-pink-600 dark:text-pink-500 hover:underline">Editar</a>
...
<div id="doctorModal" class="fixed inset-0 z-50 flex items-center justify-center hidden">
    <div class="p-6 bg-white rounded-lg shadow-lg dark:bg-gray-800" style="width: 500px; height: 900px;">
        <div class="flex items-center justify-between mb-4">
            <h2 class="text-xl font-bold">Registrar Doctor</h2>
        ...
        <form method="POST" action="{{ route('doctores.store') }}">
            ...
            <!-- Especialidad -->
            <div class="mb-4">
                <label for="especialidad" class="block mb-2 text-sm font-medium text-gray-800 dark:text-gray-200">Especialidad <span class="text-red-600">*</span></label>
                <input type="text" id="especialidad" name="especialidad" class="block w-full p-2.5 bg-gray-50 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white" placeholder="Ingrese la especialidad" required />
            </div>

            <!-- Consultorio -->
            <div class="mb-4">
                <label for="consultorio" class="block mb-2 text-sm font-medium text-gray-800 dark:text-gray-200">Consultorio <span class="text-red-600">*</span></label>
                <input type="text" id="consultorio" name="consultorio" class="block w-full p-2.5 bg-gray-50 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white" placeholder="Ingrese el consultorio" required />
            </div>
